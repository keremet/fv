...
if($id != null){
	$stmt = $db->prepare(
		"SELECT id, name, address, DATE_FORMAT(birthday, '%d%m%Y') as birthday, LPAD(pasp_ser, 4, '0') as pasp_ser, LPAD(pasp_num, 6, '0') as pasp_num, DATE_FORMAT(pasp_date, '%d%m%Y') as pasp_date, pasp_who
		 FROM ofv_uch
		 WHERE id = ?");
...
<tr><td>Адрес<td><input id="ofv_uch_address"  name="ofv_uch_address" size="30" type="text" value="<?=(($id!=null)?$uch['address']:'')?>">
<tr><td>Дата рождения<td><input id="ofv_uch_birthday"  name="ofv_uch_birthday" size="8" type="text" value="<?=(($id!=null)?$uch['birthday']:'')?>" maxlength="8" onkeyup="return proverka_dat(this);" onchange="return proverka_dat(this);">
<tr><td>Серия паспорта<td><input id="ofv_uch_pasp_ser"  name="ofv_uch_pasp_ser" size="4" type="text" value="<?=(($id!=null)?$uch['pasp_ser']:'')?>" maxlength="4" onkeyup="return proverka_dat(this);" onchange="return proverka_dat(this);">
<tr><td>Номер паспорта<td><input id="ofv_uch_pasp_num"  name="ofv_uch_pasp_num" size="6"  maxlength="6" type="text" value="<?=(($id!=null)?$uch['pasp_num']:'')?>" onkeyup="return proverka_dat(this);" onchange="return proverka_dat(this);">
<tr><td>Кем выдан паспорт<td><input id="ofv_uch_pasp_who"  name="ofv_uch_pasp_who" size="30" type="text" value="<?=(($id!=null)?$uch['pasp_who']:'')?>">
<tr><td>Дата выдачи паспорта<td><input id="ofv_uch_pasp_date"  name="ofv_uch_pasp_date" size="8"  maxlength="8" type="text" value="<?=(($id!=null)?$uch['pasp_date']:'')?>" onkeyup="return proverka_dat(this);" onchange="return proverka_dat(this);">
</table>
